    ...
    var observer = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
            ...
            $("#listings .item.active-d").each(function(i) {
                ...
                profile.innerHTML = '<div class="columns-8 w-row"><div class="s-profile-image w-col w-col-6" style="background-image: url(' + simg + ')" ><div class="s-icons"><a href="mailto:' + semail + '" target="_blank"><div class="s-icon-wrap grow-big granimate"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/6164c280a1c7f55f931c37b0_cicon.svg" loading="lazy" width="40" alt="" class="s-chat"></div></a><div data-w-id="0bb5a390-b262-7d0c-f8ef-94ac5759ee1d" class="s-icon-wrap thumbs"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/6186e3ad36ecec1ba64d4342_thumb.svg" loading="lazy" width="38" alt=""></div><div class="s-icon-wrap remove"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/5f6f7d26c770f2860fac8791_close-icon.svg" loading="lazy" width="40" alt="grey X symbol" class="s-map remove"></div></div></div><div class="column-18 w-col w-col-6"><div class="s-details"><div class="s-profile-heading">' + sname + ', <span class="s-type-law">' + stype + '</span></div><div>' + sfirm + '</div><div class="s-distance" data-p="' + sid + '"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/5e851a1cf6f6eda0543cecfe_mapbox-icon.png" loading="lazy" width="30" alt="map checkpoint" class="s-icon"><div>' + sdist + '</div></div><div class="s-secondary-heading">Practice Areas:</div><div id="pArea">' + sprac + '</div><div class="s-secondary-heading">Languages:</div><div id="pLang">' + slang + '</div><div class="social-links-container s-bio"><a href="' + stwit + '" target="_blank" class="social-block w-inline-block" tabindex="0"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/5ff60355c347a0de7ee9767f_twitter1.svg" alt="Twitter logo" class="social-icon"></a><a href="' + sface + '" target="_blank" class="social-block w-inline-block" tabindex="0"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/5ff60373c2c2b851a8f9368c_facebook1.svg" alt="Facebook Logo" class="social-icon"></a><a href="' + slinked + '" target="_blank" class="social-block w-inline-block" tabindex="0"><img src="https://uploads-ssl.webflow.com/5e5dd661bbf5f1863333707a/5ff6038b5e4963165877455b_linkedin1.svg" alt="LinkedIn Logo" class="social-icon"></a></div><div class="view-prof"><a href="profile?profile=' + smid + '" target="_blank" class="l-profile-link">View Full Profile ⟶</a></div</div>';
            });
            ...
            $('.s-distance').click(function() {
                ...
                pclick = $('#' + dp).find('a.details').attr('id');
